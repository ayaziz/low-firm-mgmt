...
import type { Document as DocType, Case } from '@/types';
    ...
    <Box>
      <Stack direction="row" justifyContent="space-between" alignItems="center" mb={2}>
        ...
        <Stack direction="row" spacing={1}>
          ...
          <Button variant="contained" startIcon={<UploadIcon />} onClick={openCreateDialog}>
            {t('document.upload')}
          </Button>
        </Stack>
      </Stack>
            ...
            <TableBody>
              {docs.map(d => (
                ...
                >
                  ...
                  <TableCell>
                    <Chip label={d.scan_status} size="small" color={SCAN_COLORS[d.scan_status] || 'default'} />
                  </TableCell>
                  <TableCell>
                    <Chip label={d.confidentiality} size="small" variant="outlined" />
                  </TableCell>
